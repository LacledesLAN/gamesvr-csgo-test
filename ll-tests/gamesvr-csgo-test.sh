#!/bin/bash -i
declare LLCK_LOGFILE="/app/ll-tests/gamesvr-csgo-test.log";
declare LLCK_CMD="/app/srcds_run -game csgo +game_type 0 +game_mode 1 -tickrate 128 +mapgroup ll_orange +map orangebox_warmup_day -insecure +sv_lan 1 -norestart";
