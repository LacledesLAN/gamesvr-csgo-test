...
First off, thank you for considering contributing to `gamesvr-srcds-csgo-test`. It's people like you that make Laclede's LAN such a great community.

### Did you find a bug or have questions?

Let us know by using [GitHub issues](https://github.com/LacledesLAN/gamesvr-srcds-csgo-test/issues) on this repository.
